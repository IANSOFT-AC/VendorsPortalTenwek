...
$profileAction = ''; //(Yii::$app->user->identity->profileID)?'update?No='.Yii::$app->user->identity->profileID:'view-profile';
        ...
        <div class="card">
            <div class="card-header">
                <div class="breadcrumbb flat">
                    ...
                    <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'attachements/index' ?>" <?= Yii::$app->recruitment->currentaction('attachements','index')?'class="active"': '' ?>>Attachements</a>
